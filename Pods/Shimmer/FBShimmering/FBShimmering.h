...
//! @abstract Set this to YES to start shimmering and NO to stop. Defaults to NO.
@property (nonatomic, assign, readwrite, getter = isShimmering) BOOL shimmering;

//! @abstract Set this to a value to start shimmering with delay
@property (assign, nonatomic, readwrite) CGFloat shimmeringWithDelay;
